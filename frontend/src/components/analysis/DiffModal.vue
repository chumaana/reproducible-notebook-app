...
/**
 * Modal component for displaying semantic diff between local and container execution results.
 * Uses an iframe to safely render HTML diff output from backend.
 */

defineProps<{
    diffHtml: string | null  // HTML string containing the diff visualization
}>()
